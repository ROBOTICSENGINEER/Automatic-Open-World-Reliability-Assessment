...
path_train = '/datasets/ImageNet/ILSVRC_2012/train/'
...
path_val = '/datasets/ImageNet/ILSVRC_2012/val_in_folders/'
...
with open('new_166_dict.json', 'r') as f:
    new_166_dict = json.load(f)

path_166 = '/datasets/ImageNet/ILSVRC_2010/train/'


with open("imagenet_166.csv", 'w') as f:
  for folder,class_number in new_166_dict.items():
