...
best_val = 80.588
state_dict_model = torch.load('./trained_efficientnet_b3_imagenet/trained_efficientnet_b3_imagenet.pth.tar')
...
for epoch in range(max_number_of_epoch):
  ...
  if top1_val.avg > best_val:
    ...
    torch.save(model.state_dict(), 'efficientnet_b3_imagenet_vall_acc_'+str(best_val)+ '.pth.tar')
