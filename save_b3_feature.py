...
model_name = 'efficientnet_b3_imagenet'
...
np.save(file = ('feature_train_' + model_name + '.npy'), arr=feature_train)
np.save(file = ('feature_val_' + model_name + '.npy'), arr=feature_val)
np.save(file = ('feature_unknown_' + model_name + '.npy'), arr=feature_unknown)
